...
#### ---- MAIN PAGE ---- ####
st.markdown(
    f"<H5 style='border-radius:25px; padding:17px; text-align:center; color:#f2f2f2; font-size:35px;background-image: linear-gradient(to right, {light_colors[0]}, #F7831Ecc, #239E70cc);'> RED LIGHT <mark style = 'font-family:liberation serif; font-size:35px; color:#F2F2F2; background-color:transparent;'>CAMERAS IN TORONTO </mark></H5>",
...
with tab1:
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown(f"<p style = 'font-size:32px;color:#ABA595;text-align:center;font-weight:normal; '> TICKET COST BREAKDOWN </p>", unsafe_allow_html=True)
    st.markdown(
...
with tab3:
    ...
    st.markdown("<p style='font-size:18px;color:#ABA595;margin-left:20px;text-align:center;'>TOTAL CHARGES FOR THE YEAR </p>", unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)
    ...
    #st.markdown("<br>", unsafe_allow_html=True)
    st.markdown(
        f"<p style = 'font-size:35px;color:#f2f2f2;border-left: 3px solid {light_colors[2]};padding-left:70px;"
        f"margin-left:5px; '>HIGHEST NUMBERS OF TICKETS</p>",
        unsafe_allow_html=True)
    st.markdown("<p style='font-size:18px;color:#ABA595;text-align:center;'>TOTAL CHARGES AT EACH LOCATION SINCE THE PROGRAM BEGAN </p>", unsafe_allow_html=True)
