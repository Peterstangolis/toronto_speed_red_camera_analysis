...
with tab3:
    ...
    st.markdown("<p style='font-size:22px;color:#f2f2f2;margin-left:20px;text-align:center;'>TOTAL CHARGES FOR THE YEAR </p>", unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)
    ...
    #st.markdown("<br>", unsafe_allow_html=True)
    st.markdown(
        f"<p style = 'font-size:35px;color:#f2f2f2;border-left: 3px solid {light_colors[2]};text-align:left;padding-left:50px;"
